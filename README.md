...
This plugin can be installed and updated using [Github Updater](https://github.com/afragen/github-updater) ([installation instructions](https://github.com/afragen/github-updater/wiki/Installation)). Once you have installed this plugin, you can easily and optionally install the other optimization plugins from the *WordPress WPO* tab.
